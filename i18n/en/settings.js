...
Making any changes to your password setting will keep your data as it was before and restart the app.\n    
  ...
  supabaseSync: {
    ...
    fullResyncButton: 'Full resync',
    fullResyncTitle: 'Full resync',
    fullResyncMessage: 'This will re-upload ALL cycle days to Supabase. Continue?',
    fullResyncConfirm: 'Resync all',
    statusTitle: 'Status',
